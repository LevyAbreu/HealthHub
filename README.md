...
Healthub é um aplicativo Android dedicado ao monitoramento de saúde do usuário. Ele foi projetado para ajudar os usuários a rastrear e gerenciar suas métricas de saúde de forma simples e eficaz.
...
- Promover hábitos saudáveis entre os usuários.
- Facilitar o acesso a dados de saúde de forma visual e interativa.
- Servir como uma ferramenta auxiliar para o bem-estar geral.
